 ...
 *
 * First Commit
 *    Add a print statement to the bottom of the main method below.
 *    Your print must contain your full name.
 *
 *    Follow the lab instructions carefully!
 *    If you get a merge conflict, refer to course notes & slides for help!
 */
public class FirstCommit {
	...
	public static void main( String[] args ) {
		...
		System.out.println("My name is Elijah Lozano and my hobby is cycling and I like video games.");
	}
}
...
public class FirstCommit {
    ...
    System.out.println("My name is Elijah Lozano and my other hobby is watching movies.");
	}
}
